...
<form class="form-horizontal" role="form">
          <div class="form-group">
            <label for="first_name" class="col-lg-3 control-label">Nombre:</label>
            <div class="col-lg-8">
              <input  id="first_name" class="form-control" type="text" placeholder="Nuevo nombre">
            </div>
          </div>
          <div class="form-group">
            <label for="last_name" class="col-lg-3 control-label">Apellido:</label>
            <div class="col-lg-8">
              <input  id="last_name" class="form-control" type="text" placeholder="Nuevo apellido">
            </div>
          </div>
          <div class="form-group">
            <label for="company" class="col-lg-3 control-label">Luegar de nacimiento?:</label>
            <div class="col-lg-8">
          ...
          <div class="form-group">
            <label for="pass_repet" class="col-md-3 control-label">Confirmación de contraseña:</label>
            <div class="col-md-8">
